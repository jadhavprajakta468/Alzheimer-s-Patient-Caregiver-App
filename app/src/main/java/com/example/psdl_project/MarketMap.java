...
public class MarketMap extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void getLastLocation() {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(location -> {
            if (location != null) {
                ...
                Toast.makeText(MarketMap.this, "Failed to retrieve location. Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
