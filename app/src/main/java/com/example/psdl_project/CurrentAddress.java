...
public class CurrentAddress extends AppCompatActivity implements OnMapReadyCallback {

    private final static int FINE_PERMISSION_CODE = 1;
    private GoogleMap myMap;
    private Location currentLocation;
    private FusedLocationProviderClient fusedLocationProviderClient;
    private final String presetLocation = "PVVV+3H4, Unnamed Road, Rase, Maharashtra 410501";
    ...
    private void getLastLocation() {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(location -> {
            if (location != null) {
                ...
                Toast.makeText(CurrentAddress.this, "Failed to retrieve location. Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
